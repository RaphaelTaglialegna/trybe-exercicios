...
//   let filterGenre =  books.filter((book) => book.genre === 'Ficção Científica' || book.genre === 'Fantasia' );
//   return filterGenre.map((book) => book.author.name).sort();
// }
...
// function oldBooks() {
//   let booksSixty = books.filter((book) => 2021 - book.releaseYear > 60);
//   return booksSixty.map((book) => book.name);
// }
